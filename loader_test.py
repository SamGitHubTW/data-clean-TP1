    ...
    df = pd.DataFrame(
        data={
            'nom': ['Plateau sportif de GrammontTerrain 9, 10, 11',
                    ...
                    'Vestiaire/tribune CLAUDE BEAL',
                    'Ecole élémentaire Winston Churchill - Ecole maternelle Marceline Desbordes-Valmore'],
            'Adress': ['pd.NA avenue albert Einstein 34000 Montpellier',
                        'pd.NA pd.NA pd.NA pd.NA',
                        '694-700 rue Jacques-Bounin 34070 Montpellier',
                        'pd.NA pd.NA pd.NA Montpellier',
                        ...
                        '41 impasse des Moulins 34000 pd.NA',
                        '1 rond-point Benjamin Franklin pd.NA Montpellier',
                        'pd.NA Rue Pierre Gilles de Gennes 34000 Montpellier',
